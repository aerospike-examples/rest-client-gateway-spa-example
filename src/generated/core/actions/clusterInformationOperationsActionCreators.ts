...
const api = new gapi.ClusterInformationOperationsApi(
  conf,
...
export const doGetClusterInfo = (
  ...
  dispatch: ThunkDispatch<StoreState, void, GetClusterInfoAction | RouterAction>
) => {
  const calls = new ApiActionCreatorExtender<
    ClusterInformation,
    RestClientError
  >(
    {
