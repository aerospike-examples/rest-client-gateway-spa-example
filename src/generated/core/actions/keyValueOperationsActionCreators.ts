...
const api = new gapi.KeyValueOperationsApi(
  conf,
...
export const doGetRecordNamespaceKey = ({
  ...
  dispatch: ThunkDispatch<
    StoreState,
    void,
    GetRecordNamespaceKeyAction | RouterAction
  >
) => {
  ...
  try {
    ...
    return calls.error(
      [getRecordNamespaceKeyFailed(xformedError)],
      xformedError
    );
  }
};
...
export const doRecordExistsNamespaceKey = (
  ...
  dispatch: ThunkDispatch<
    StoreState,
    void,
    RecordExistsNamespaceKeyAction | RouterAction
  >
) => {
  ...
  try {
    ...
    const xformedError = await xformApiResponse(error);
    return calls.error(
      [recordExistsNamespaceKeyFailed(xformedError)],
      xformedError
    );
  }
};
...
export const doCreateRecordNamespaceKey = ({
  ...
  dispatch: ThunkDispatch<
    StoreState,
    void,
    CreateRecordNamespaceKeyAction | RouterAction
  >
) => {
  const calls = new ApiActionCreatorExtender<SimpleResponse, RestClientError>(
    {
  ...
  try {
    ...
    const xformedError = await xformApiResponse(error);
    return calls.error(
      [createRecordNamespaceKeyFailed(xformedError)],
      xformedError
    );
  }
};
...
export const doReplaceRecordNamespaceKey = ({
  ...
  dispatch: ThunkDispatch<
    StoreState,
    void,
    ReplaceRecordNamespaceKeyAction | RouterAction
  >
) => {
  const calls = new ApiActionCreatorExtender<SimpleResponse, RestClientError>(
    {
  ...
  try {
    ...
    const xformedError = await xformApiResponse(error);
    return calls.error(
      [replaceRecordNamespaceKeyFailed(xformedError)],
      xformedError
    );
  }
};
...
export const doDeleteRecordNamespaceKey = ({
  ...
  dispatch: ThunkDispatch<
    StoreState,
    void,
    DeleteRecordNamespaceKeyAction | RouterAction
  >
) => {
  const calls = new ApiActionCreatorExtender<SimpleResponse, RestClientError>(
    {
  ...
  try {
    ...
    const xformedError = await xformApiResponse(error);
    return calls.error(
      [deleteRecordNamespaceKeyFailed(xformedError)],
      xformedError
    );
  }
};
...
export const doUpdateRecordNamespaceKey = ({
  ...
  dispatch: ThunkDispatch<
    StoreState,
    void,
    UpdateRecordNamespaceKeyAction | RouterAction
  >
) => {
  const calls = new ApiActionCreatorExtender<SimpleResponse, RestClientError>(
    {
  ...
  try {
    ...
    const xformedError = await xformApiResponse(error);
    return calls.error(
      [updateRecordNamespaceKeyFailed(xformedError)],
      xformedError
    );
  }
};
...
export const doGetRecordNamespaceSetKey = ({
  ...
  dispatch: ThunkDispatch<
    StoreState,
    void,
    GetRecordNamespaceSetKeyAction | RouterAction
  >
) => {
  const calls = new ApiActionCreatorExtender<Record, RestClientError>(
    {
  ...
  try {
    ...
    const xformedError = await xformApiResponse(error);
    return calls.error(
      [getRecordNamespaceSetKeyFailed(xformedError)],
      xformedError
    );
  }
};
...
export const doRecordExistsNamespaceSetKey = (
  ...
  dispatch: ThunkDispatch<
    StoreState,
    void,
    RecordExistsNamespaceSetKeyAction | RouterAction
  >
) => {
  const calls = new ApiActionCreatorExtender<SimpleResponse, RestClientError>(
    {
  ...
  try {
    ...
    const xformedError = await xformApiResponse(error);
    return calls.error(
      [recordExistsNamespaceSetKeyFailed(xformedError)],
      xformedError
    );
  }
};
...
export const doCreateRecordNamespaceSetKey = ({
  ...
  dispatch: ThunkDispatch<
    StoreState,
    void,
    CreateRecordNamespaceSetKeyAction | RouterAction
  >
) => {
  const calls = new ApiActionCreatorExtender<SimpleResponse, RestClientError>(
    {
  ...
  try {
    ...
    const xformedError = await xformApiResponse(error);
    return calls.error(
      [createRecordNamespaceSetKeyFailed(xformedError)],
      xformedError
    );
  }
};
...
export const doReplaceRecordNamespaceSetKey = ({
  ...
  dispatch: ThunkDispatch<
    StoreState,
    void,
    ReplaceRecordNamespaceSetKeyAction | RouterAction
  >
) => {
  const calls = new ApiActionCreatorExtender<SimpleResponse, RestClientError>(
    {
  ...
  try {
    ...
    const xformedError = await xformApiResponse(error);
    return calls.error(
      [replaceRecordNamespaceSetKeyFailed(xformedError)],
      xformedError
    );
  }
};
...
export const doDeleteRecordNamespaceSetKey = ({
  ...
  dispatch: ThunkDispatch<
    StoreState,
    void,
    DeleteRecordNamespaceSetKeyAction | RouterAction
  >
) => {
  const calls = new ApiActionCreatorExtender<SimpleResponse, RestClientError>(
    {
  ...
  try {
    ...
    const xformedError = await xformApiResponse(error);
    return calls.error(
      [deleteRecordNamespaceSetKeyFailed(xformedError)],
      xformedError
    );
  }
};
...
export const doUpdateRecordNamespaceSetKey = ({
  ...
  dispatch: ThunkDispatch<
    StoreState,
    void,
    UpdateRecordNamespaceSetKeyAction | RouterAction
  >
) => {
  const calls = new ApiActionCreatorExtender<SimpleResponse, RestClientError>(
    {
  ...
  try {
    ...
    const xformedError = await xformApiResponse(error);
    return calls.error(
      [updateRecordNamespaceSetKeyFailed(xformedError)],
      xformedError
    );
  }
};
