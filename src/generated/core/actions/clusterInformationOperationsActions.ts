...
export const getClusterInfoSuccessful = (
  res: ClusterInformation
...
export const getClusterInfoFailed = (
  res: RestClientError
...
export type GetClusterInfoInProgress = Action<
  typeof GET_CLUSTER_INFO_IN_PROGRESS
>;
