...
export const OPERATE_NAMESPACE_KEY_SUCCESSFUL =
...
export const operateNamespaceKeySuccessful = (
  res: Record
...
export const operateNamespaceKeyFailed = (
  res: RestClientError
...
export const OPERATE_NAMESPACE_KEY_IN_PROGRESS =
  "OPERATE_NAMESPACE_KEY_IN_PROGRESS";
export type OperateNamespaceKeyInProgress = Action<
  typeof OPERATE_NAMESPACE_KEY_IN_PROGRESS
>;
...
export const OPERATE_NAMESPACE_SET_KEY_SUCCESSFUL =
...
export const OPERATE_NAMESPACE_SET_KEY_FAILED =
...
export const OPERATE_NAMESPACE_SET_KEY_IN_PROGRESS =
  "OPERATE_NAMESPACE_SET_KEY_IN_PROGRESS";
export type OperateNamespaceSetKeyInProgress = Action<
  typeof OPERATE_NAMESPACE_SET_KEY_IN_PROGRESS
>;
...
export type OperateOperationsAction =
