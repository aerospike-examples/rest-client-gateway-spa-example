...
import { Field, FieldArray, Form, FormikProps, FormikValues, withFormik } from 'formik';
...
const AddRecipeFormComponent = (props: AddRecipeProps & FormikProps<Recipe>) => (
    <Grid container direction="column">
        <Form>
            <Field
                ...
                required
                fullWidth
                validate={(val: any) => (val === '' ? 'Value cannot be empty' : undefined)}
                component={TextField}
            />
            <Field
                name="description"
