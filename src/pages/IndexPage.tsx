...
export class IndexComponent extends React.PureComponent<IndexProps> {
  ...
  public render() {
        ...
        <Grid container direction="column" justify="space-between">
          <Grid item>
            ...
            <Typography variant="h6">
              Keep a cookbook of recipes saved to your personal account. Login
              to try it out!
            </Typography>
          </Grid>{" "}
          <Grid item>
            ...
            >
              <Typography variant="h6">
                ...
                Aerospike database along with the Aerospike REST client gateway
                in a Single Page Application setting without a custom server.{" "}
                <Link component={AboutLink}>
    ...
    return <Page lastResponse={this.props.lastResponse}>{content}</Page>;
  }
}
